...
?>
<div class="tabs3"><a href='index.php'><button class='leftback'><i class="fa fa-chevron-left"></i></button></a><?php echo $nama ?>
	</div>
<div class='msgs'>
...
<form id="msg_form" method="POST">
  ...
  <input name="name" id="name" type="hidden" value="<?php echo $nama ?>" />
